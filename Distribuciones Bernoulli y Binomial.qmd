...
ggplot(binomial_monedas, aes(x = Num_Caras, y = Probabilidad)) +
  ...
  geom_vline(xintercept = media_monedas, color = "black", linetype = "dashed", size = 1) +
  annotate("text", x = media_monedas + 2.5, y = max(prob_binomial) * 0.8, 
           label = paste("Media =", media_monedas), color = "black") +
...
ggplot(calidad_data[1:8, ], aes(x = Defectos, y = Probabilidad)) +
  ...
  geom_vline(xintercept = media_defectos, color = "black", linetype = "dashed", size = 1) +
...
ggplot(comp_p_data, aes(x = k, y = probabilidad)) +
  ...
  geom_vline(aes(xintercept = media), color = "black", linetype = "dashed") +
...
ggplot(comp_sim_long, aes(x = k, y = Probabilidad, fill = Tipo)) +
  ...
  scale_fill_manual(values = c("Teórica" = "lightgreen", "Simulada" = "darkred")) +
...
ggplot(comp_rel_long, aes(x = Valor, fill = Metodo)) +
  ...
  scale_fill_manual(values = c("Binomial_Directo" = "green", "Suma_Bernoulli" = "darkred")) +
...
if(condicion1 & condicion2) {
  ...
  ggplot(aprox_long, aes(x = k, y = Densidad, color = Distribucion)) +
    geom_line(size = 1) +
    geom_point(size = 2) +
    scale_color_manual(values = c("Binomial" = "green", "Normal" = "darkred")) +
...
ggplot(medicina_data, aes(x = k, y = probabilidad)) +
  geom_col(fill = "green", alpha = 0.7, width = 0.8) +
  geom_vline(xintercept = media_curas, color = "darkred", linetype = "dashed", size = 1) +
  geom_vline(xintercept = c(18, 22), color = "black", linetype = "dotted", size = 1) +
  annotate("text", x = media_curas + 1.5, y = max(prob_medicina) * 0.8, 
           label = paste("E[X] =", media_curas), color = "darkred") +
...
simulacion_plot <- ggplot(z_data, aes(x=Z, y=after_stat(density))) +
  geom_histogram(bins = n_z_teorico + 1, fill = "green", alpha = 0.7, color = "black") +
