...
ggplot(data_comp, aes(x = k, y = Probabilidad, fill = Tipo)) +
  ...
  scale_fill_manual(values = c("Teórica" = "#1a56C1", "Simulada" = "#a45C3C")) 
```
...
ggplot(data_conv) +
  geom_line(aes(x = n, y = Media_simulada), color = "#a45C3C", linewidth = 1) +
  geom_hline(yintercept = media_teorica, color = "#1a56C1", 
...
ggplot(data_hist, aes(x = valores, fill = distribucion)) +
  ...
  theme_minimal() +
  theme(legend.position = "none") +
  scale_fill_manual(values = c("#7508DB", "#a55E22"))
```
...
ggplot(data_tcl, aes(x = valores_norm)) +
  geom_histogram(aes(y = after_stat(density)), alpha = 0.6, bins = 30, fill = "#7508DB") +
  stat_function(fun = dnorm, args = list(mean = 0, sd = 1), 
                color = "#a45C3C", linewidth = 1.2, linetype = "dashed") +
...
ggplot(data_comparacion, aes(x = valores, fill = metodo)) +
  ...
  theme_minimal() +
  theme(legend.position = "none") +
  scale_fill_manual(values = c("#7508DB", "#a45C3C"))
```
...
ggplot(data.frame(iteraciones = iteraciones_fallidas), aes(x = iteraciones)) +
  geom_histogram(aes(y = after_stat(density)), bins = 30, fill = "#7508DB", alpha = 0.7) +
  geom_vline(xintercept = media_iteraciones, color = "#a45C3C", 
...
plot2 <- ggplot(data_sim2, aes(x=Fallas)) +
  geom_histogram(aes(y = after_stat(density)), bins = max(fallos_simulados)+1, 
                 fill = "darkred", alpha = 0.7, color = "purple") +
  geom_vline(xintercept = esperanza_fallos, color = "green", linetype = "dashed", linewidth = 1) +
