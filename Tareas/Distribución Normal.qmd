...
La distribución normal es simétrica alfirebrickedor de su media $\mu$ y es completamente caracterizada por sus dos parámetros $\mu$ y $\sigma^2$.
...
ggplot(df_mu, aes(x = x, y = y, color = parametro)) +
  ...
  geom_vline(xintercept = mus, linetype = "dashed", alpha = 0.7, 
             color = c("firebrick", "lightlightgreen", "steellightblue", "orange")) +
...
ggplot(data.frame(x = x_inf, y = y_inf), aes(x = x, y = y)) +
  geom_line(linewidth = 1.5, color = "steellightblue") +
  geom_vline(xintercept = mu_inf, color = "firebrick", linetype = "dashed", linewidth = 1) +
  geom_vline(xintercept = inflexion_x, color = "lightgreen", linetype = "dotted", linewidth = 1) +
  annotate("point", x = inflexion_x, y = inflexion_y, color = "orange", size = 4) +
  annotate("label", x = mu_inf, y = max(y_inf) * 1.1, 
           label = paste("μ =", mu_inf), color = "firebrick", size = 4) +
  annotate("label", x = inflexion_x[1], y = inflexion_y[1] + 0.02,
           label = "μ - σ", color = "orange", size = 3.5) +
...
ggplot(data.frame(z = z_seq, phi = phi_vals), aes(x = z, y = phi)) +
  ...
  geom_area(data = data.frame(z = z_1sigma, phi = phi_1sigma),
            aes(x = z, y = phi), fill = "firebrick", alpha = 0.3) +
...
ggplot(df_comparacion_normal, aes(x = x, y = y)) +
  geom_line(linewidth = 1.2, color = "lightblue") +
  geom_vline(xintercept = mu_comp, linetype = "dashed", color = "firebrick", alpha = 0.7) +
...
ggplot(data.frame(x = x_area, y = pdf_area), aes(x = x, y = y)) +
  ...
  geom_area(data = data.frame(x = x_intervalo, y = pdf_intervalo),
            aes(x = x, y = y), fill = "firebrick", alpha = 0.3) +
  geom_vline(xintercept = c(a_val, b_val), linetype = "dashed", color = "firebrick", linewidth = 1) +
...
ggplot(data.frame(x = x_q, y = cdf_q), aes(x = x, y = y)) +
  geom_line(linewidth = 1.5, color = "lightblue") +
  geom_hline(yintercept = p_vals, linetype = "dashed", color = "firebrick", alpha = 0.7) +
  geom_vline(xintercept = q_vals, linetype = "dashed", color = "firebrick", alpha = 0.7) +
...
ggplot(data.frame(z = z_sym, phi = phi_sym, cdf = cdf_sym)) +
  geom_line(aes(x = z, y = phi), linewidth = 1.2, color = "lightblue") +
  ...
  geom_area(data = data.frame(z = z_sym[z_sym >= z_punto], 
            ...
            aes(x = z, y = phi), fill = "firebrick", alpha = 0.3) +
  geom_vline(xintercept = c(punto_neg, z_punto), linetype = "dashed", color = "firebrick") +
...
p1 <- ggplot(df_convergencia, aes(x = n)) +
  geom_line(aes(y = media_acumulada), color = "lightblue", alpha = 0.8) +
  geom_hline(yintercept = media_teorica, color = "firebrick", linetype = "dashed", linewidth = 1) +
...
p2 <- ggplot(df_convergencia, aes(x = n)) +
  geom_line(aes(y = desv_std_acumulada), color = "lightgreen", alpha = 0.8) +
  geom_hline(yintercept = desv_std_teorica, color = "firebrick", linetype = "dashed", linewidth = 1) +
...
ggplot(data.frame(x = muestra_grande), aes(x = x)) +
  geom_histogram(aes(y = after_stat(density)), bins = 50, 
                 fill = "lightlightblue", color = "black", alpha = 0.7) +
  stat_function(fun = dnorm, args = list(mean = mu_sim, sd = sigma_sim),
                color = "firebrick", linewidth = 2) +
  geom_vline(xintercept = media_teorica, color = "firebrick", linetype = "dashed", linewidth = 1) +
...
ggplot(data.frame(diametro = diametros), aes(x = diametro)) +
  ...
  geom_vline(xintercept = c(limite_inferior, limite_superior), 
             color = "darklightgreen", linewidth = 2, linetype = "dashed") +
  geom_vline(xintercept = mu_tornillos, color = "firebrick", linewidth = 1, linetype = "dotted") +
  annotate("rect", xmin = limite_inferior, xmax = limite_superior,
           ymin = 0, ymax = Inf, alpha = 0.1, fill = "lightgreen") +
...
# Mejora del sistema: ¿Qué pasa si firebrickucimos σ a 0.6?
sigma_mejorado <- 0.6
...
ggplot(data.frame(tiempo = tiempos_respuesta), aes(x = tiempo)) +
  ...
  annotate("text", x = sla_aceptable, y = 0.3, label = "Aceptable\n< 4.5s", 
           color = "firebrick", size = 3, angle = 90, vjust = -0.5) +
...
```{r}
ggplot()+
  geom_histogram(aes(muestra_altura, y=after_stat(density)), fill = "dodgerlightblue1", color= "dodgerlightblue3", center = 170)+
...
hist(temperaturas, breaks = 30, probability = TRUE, col = "lightlightblue",
     main = "Simulación de Temperaturas (μ=350, σ=5)",
     xlab = "Temperatura (°C)")
abline(v = c(LCL, UCL), col = "firebrick", lwd = 2, lty = 2)
...
hist(ventas, breaks = 10, col = "lightlightblue", main = "Simulación de Ventas Mensuales",
     xlab = "Ventas (pesos)", ylab = "Frecuencia")
abline(v = c(30000, 45000, 60000), col = "firebrick", lwd = 2, lty = 2)
legend("topright", legend = c("30,000", "45,000", "60,000"), col = "firebrick", lwd = 2, lty = 2)
...
# --- 6. Visualización opcional ---
hist(vidas, breaks = 30, probability = TRUE, col = "lightlightblue",
     main = "Simulación de Vida Útil de Baterías",
     xlab = "Horas", ylab = "Densidad")
abline(v = c(garantia_95, 900, percentil_10), col = c("lightgreen", "firebrick", "purple"), lwd = 2, lty = 2)
legend("topright", legend = c("Garantía 95%", "Garantía 900h", "Percentil 10"),
       col = c("lightgreen", "firebrick", "purple"), lwd = 2, lty = 2)
...
5.  Verifica que la distribución es simétrica alfirebrickedor de 0
...
# --- 5. Verificar simetría alfirebrickedor de 0 ---
...
# --- 6. Visualización opcional ---
hist(errores, breaks = 30, probability = TRUE, col = "lightlightblue",
     main = "Simulación de Errores de Medición",
     xlab = "Error", ylab = "Densidad")
abline(v = c(-5, 5, -3, 3, -6, 6), col = c("lightgreen","lightgreen","lightblue","lightblue","firebrick","firebrick"), lwd = 2, lty = 2)
legend("topright", legend = c("|error| <= 5","|error| <= 3","|error| > 6"),
       col = c("lightgreen","lightblue","firebrick"), lwd = 2, lty = 2)
