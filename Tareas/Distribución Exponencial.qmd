...
ggplot(data.frame(x = x_area, y = y_area), aes(x = x, y = y)) +
  ...
  geom_vline(xintercept = c(a_ej, b_ej), linetype = "dashed", color = "firebrick") +
...
ggplot(data.frame(x = x_cuant, y = y_cuant), aes(x = x, y = y)) +
  ...
  annotate("point", x = q1, y = 0.25, color = "firebrick", size = 3) +
  annotate("point", x = mediana, y = 0.5, color = "firebrick", size = 3) +
  annotate("point", x = q3, y = 0.75, color = "firebrick", size = 3) +
  annotate("text", x = q1, y = 0.15, label = "Q1", size = 4, color = "firebrick") +
  annotate("text", x = mediana, y = 0.4, label = "Q2", size = 4, color = "firebrick") +
  annotate("text", x = q3, y = 0.65, label = "Q3", size = 4, color = "firebrick") +
...
ggplot(data.frame(x = x_vals, y = y_vals), aes(x = x, y = y)) +
  ...
  geom_vline(xintercept = media_ej, color = "darkred", linewidth = 1.2, linetype = "dotted") +
  annotate("text", x = mediana_ej + 0.05, y = 0.8, 
           label = paste("Mediana =", round(mediana_ej, 3)), color = "green", size = 4, angle = 90, hjust = 0) +
  annotate("text", x = media_ej + 0.05, y = 0.6, 
           label = paste("Media =", round(media_ej, 3)), color = "darkred", size = 4, angle = 90, hjust = 0) +
...
p1 <- ggplot(df_convergencia, aes(x = n)) +
  geom_line(aes(y = media_acumulada), color = "steelblue", alpha = 0.8) +
...
p2 <- ggplot(df_convergencia, aes(x = n)) +
  ...
  geom_hline(yintercept = varianza_teorica, color = "firebrick", linetype = "dashed", linewidth = 1) +
...
ggplot(data.frame(tiempo = tiempos_validos), aes(x = tiempo)) +
  ...
  stat_function(fun = dexp, args = list(rate = lambda_banco), 
                color = "firebrick", linewidth = 2) +
  geom_vline(xintercept = 1/lambda_banco, color = "steelblue", linetype = "dashed", linewidth = 1) +
...
ggplot(data.frame(vida = vidas_utiles), aes(x = vida)) +
  ...
  stat_function(fun = dexp, args = list(rate = lambda_leds), 
                color = "firebrick", linewidth = 2) +
  geom_vline(xintercept = garantia, color = "steelblue", linetype = "dashed", linewidth = 1.2) +
...
p1 <- ggplot(data.frame(tiempo = tiempos_ms), aes(x = tiempo)) +
  geom_histogram(aes(y = after_stat(density)), bins = 50, 
                 fill = "lightsteelsteelblue", color = "black", alpha = 0.7) +
...
ggplot(estadisticos_tcl, aes(x = n)) +
  ...
  scale_color_manual(values = c("Observada" = "steelblue", "Teórica" = "firebrick")) +
