...
p_casos <- ggplot() +
  ...
  geom_function(fun = function(x) dchisq(x, df = 4), 
                ...
                xlim = c(0.01, 12), size = 1.4) +
  scale_color_manual(
    values = c("#a30a1c", "#3f34b4", "#99e02c", "#ff7f44"),
    name = "Casos\nEspeciales"
  ) +
...
for (i in seq_along(n_grandes)) {
  ...
  plots_normal[[i]] <- ggplot() +
    ...
    scale_color_manual(
      values = c("Ji-cuadrada" = "#d62354", "Normal" = "#2ca87c"),
      name = "Distribución"
    ) +
...
p_especiales <- ggplot() +
  ...
  scale_color_manual(
    name = "Grados de\nLibertad",
    values = c("n = 1" = "#a30a1c", "n = 2" = "#3f34b4", 
               "n = 3" = "#99e02c", "n = 4" = "#ff7f44"),
...
p_relacion <- ggplot() +
  ...
  geom_vline(xintercept = 8, linetype = "dashed", color = "darkred", alpha = 0.8) +
  annotate("label", x = 9, y = 0.2, label = paste("F(8)=P(X ≤ 8)=", round(pchisq(8, n_ejemplo), 3)), color = "black", size = 4.1)+
  scale_color_manual(
    name = "Función",
    values = c("PDF f(x)" = "#d62354", "CDF F(x) × 0.5" = "#1f77b4"),
  ...
  theme(
    ...
    plot.subtitle = element_text(hjust = 0.5, size = 12),
    axis.title = element_text(size = 12),
    axis.title.y = element_text(color = "#d62354"),
...
p_media <- ggplot(df_media, aes(x = n, y = media_teorica)) +
  ...
  geom_abline(intercept = 0, slope = 1, linetype = "dashed", alpha = 0.6, color = "blue") +
  labs(
...
colores_moda <- c("#a30a1c", "#3f34b4", "#99e02c", "#ff7f44", "#6A3D9A")
...
p_casos_moda <- ggplot() +
  ...
  # Puntos en las modas
  geom_point(aes(x = 0, y = dchisq(0, 2)), color = "#3f34b4", size = 4) +
  geom_point(aes(x = 2, y = dchisq(2, 4)), color = "#99e02c", size = 4) +
  geom_point(aes(x = 6, y = dchisq(6, 8)), color = "#ff7f44", size = 4) +
...
p_var_desv <- ggplot(df_varianza, aes(x = n)) +
  ...
  scale_color_manual(
    name = "Medida",
    values = c("Varianza" = "#E98759", "Desviación Estándar" = "#12B7B2"),
  ...
  annotate("text", x = 30, y = 80, label = "Var(X) = 2n", 
           color = "#E98759", size = 4.5, fontface = "bold") +
  annotate("text", x = 40, y = 15, label = "σ = √(2n)", 
           color = "#12B7B2", size = 4.5, fontface = "bold")+ 
  theme_minimal() +
  theme(
    plot.title = element_text(hjust = 0.5, size = 14, face = "bold"),
    plot.subtitle = element_text(hjust = 0.5, size = 12),
...
p_cv <- ggplot(df_varianza, aes(x = n, y = coef_variacion)) +
  geom_line(size = 1.5, color = "#be3AA1") +
  geom_point(size = 2, color = "#be3AA1", alpha = 0.7) +
  ...
  annotate("text", x = 45, y = 0.1, label = "CV → 0 cuando n → ∞", 
           color = "#be3AA1", size = 3.5, fontface = "italic")+ 
  theme_minimal() +
  theme(
    plot.title = element_text(hjust = 0.5, size = 14, face = "bold"),
    plot.subtitle = element_text(hjust = 0.5, size = 12),
...
analizar_convergencia <- function(grados_libertad, n_max = 10000) {
  ...
  p_media <- ggplot(df_convergencia, aes(x = n, y = media)) +
    ...
    geom_hline(yintercept = media_teorica, color = "orange", linetype = "dashed", linewidth = 1.2) +
    labs(
  ...
  p_varianza <- ggplot(df_convergencia, aes(x = n, y = varianza)) +
    ...
    geom_hline(yintercept = varianza_teorica, color = "orange", linetype = "dashed", linewidth = 1.2) +
    labs(
...
comparar_aproximacion_normal <- function(grados_libertad, num_muestras = 10000) {
  ...
  ggplot(data.frame(x = muestra_ji), aes(x = x)) +
    geom_histogram(aes(y = after_stat(density)), bins = 50,
                   fill = "firebrick", color = "black", alpha = 0.7) +
    ...
    scale_color_manual(name = "Distribución", values = c("Ji-cuadrada Teórica" = "darkred", "Aproximación Normal" = "lightblue")) +
    labs(
